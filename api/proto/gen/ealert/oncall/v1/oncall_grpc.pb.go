...
const (
	OnCallService_GetCurrentSchedule_FullMethodName       = "/ealert.oncall.v1.OnCallService/GetCurrentSchedule"
	OnCallService_GetCurrentSchedulesByIDs_FullMethodName = "/ealert.oncall.v1.OnCallService/GetCurrentSchedulesByIDs"
)
...
type OnCallServiceClient interface {
	...
	GetCurrentSchedule(ctx context.Context, in *GetCurrentScheduleRequest, opts ...grpc.CallOption) (*GetCurrentScheduleResponse, error)
	// GetCurrentSchedulesByIDs 批量查找多个排班的当前值班信息
	GetCurrentSchedulesByIDs(ctx context.Context, in *GetCurrentSchedulesByIDsRequest, opts ...grpc.CallOption) (*GetCurrentSchedulesByIDsResponse, error)
}
...
func (c *onCallServiceClient) GetCurrentSchedule(ctx context.Context, in *GetCurrentScheduleRequest, opts ...grpc.CallOption) (*GetCurrentScheduleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetCurrentScheduleResponse)
...
func (c *onCallServiceClient) GetCurrentSchedulesByIDs(ctx context.Context, in *GetCurrentSchedulesByIDsRequest, opts ...grpc.CallOption) (*GetCurrentSchedulesByIDsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetCurrentSchedulesByIDsResponse)
...
type OnCallServiceServer interface {
	// GetCurrentSchedule 查找单个排班的当前值班信息
	GetCurrentSchedule(context.Context, *GetCurrentScheduleRequest) (*GetCurrentScheduleResponse, error)
	// GetCurrentSchedulesByIDs 批量查找多个排班的当前值班信息
	GetCurrentSchedulesByIDs(context.Context, *GetCurrentSchedulesByIDsRequest) (*GetCurrentSchedulesByIDsResponse, error)
...
func (UnimplementedOnCallServiceServer) GetCurrentSchedule(context.Context, *GetCurrentScheduleRequest) (*GetCurrentScheduleResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCurrentSchedule not implemented")
}
func (UnimplementedOnCallServiceServer) GetCurrentSchedulesByIDs(context.Context, *GetCurrentSchedulesByIDsRequest) (*GetCurrentSchedulesByIDsResponse, error) {
...
var OnCallService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ealert.oncall.v1.OnCallService",
	...
	Metadata: "ealert/oncall/v1/oncall.proto",
}
