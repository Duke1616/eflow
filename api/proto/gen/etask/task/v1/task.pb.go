...
const file_etask_task_v1_task_proto_rawDesc = "" +
	"\n" +
	"\x18etask/task/v1/task.proto\x12\retask.task.v1\"\xeb\x01\n" +
	"\n" +
	"GrpcConfig\x12!\n" +
	...
	"\x06params\x18\x02 \x03(\v2%.etask.task.v1.HTTPConfig.ParamsEntryR\x06params\x1a9\n" +
	"\vParamsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x11com.etask.task.v1B\tTaskProtoP\x01Z<github.com/Duke1616/eflow/api/proto/gen/etask/task/v1;taskv1\xa2\x02\x03ETX\xaa\x02\rEtask.Task.V1\xca\x02\rEtask\\Task\\V1\xe2\x02\x19Etask\\Task\\V1\\GPBMetadata\xea\x02\x0fEtask::Task::V1b\x06proto3"
