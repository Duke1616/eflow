...
const file_eiam_user_v1_user_proto_rawDesc = "" +
	...
	"\n" +
	"QueryByIds\x12\x1b.eiam.user.v1.QueryByIdsReq\x1a\x1c.eiam.user.v1.QueryUsersRespB\xac\x01\n" +
	"\x10com.eiam.user.v1B\tUserProtoP\x01Z;github.com/Duke1616/eflow/api/proto/gen/eiam/user/v1;userv1\xa2\x02\x03EUX\xaa\x02\fEiam.User.V1\xca\x02\fEiam\\User\\V1\xe2\x02\x18Eiam\\User\\V1\\GPBMetadata\xea\x02\x0eEiam::User::V1b\x06proto3"
