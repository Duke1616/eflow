...
func InitApp() (*App, error) {
	...
	taskServiceClient := ecmdbClient.TaskClient
	...
	teamServiceClient := ecmdbClient.TeamClient
	...
	taskExecutionServiceClient := ecmdbClient.ExecutorClient
	...
	larkCallbackTicketServer := ticket3.NewLarkCallbackTicketServer(iLarkCallbackHandler, larkClient)
