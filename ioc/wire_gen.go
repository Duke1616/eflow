...
func InitApp() (*App, error) {
	...
	crypto := InitCrypto()
	iRunnerRepository := repository.NewRunnerRepository(iRunnerDAO, crypto)
	...
	taskRepository := repository.NewTaskRepository(taskDAO, crypto)
	...
	component := InitGinWebServer(v, sdk, syncer, v2, handler, workflowHandler, codebookHandler, runnerHandler, taskHandler, ticketHandler, dispatchHandler, listener)
