...
func InitApp() (*App, error) {
	...
	v3 := InitTasks(taskService, engineService, taskExecutionServiceClient, executeResultConsumer, processEventConsumer, wechatTicketConsumer, larkCallbackTicketServer, wechatApprovalCallbackConsumer)
	app := &App{
		Web:   component,
		Event: processEvent,
		Tasks: v3,
