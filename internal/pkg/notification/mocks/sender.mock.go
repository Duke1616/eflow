...
func (m *MockNotificationSender) BatchSend(ctx context.Context, notifications []notification.Notification) (notification.Response, error) {
	m.ctrl.T.Helper()
...
func (c *MockNotificationSenderBatchSendCall) Return(arg0 notification.Response, arg1 error) *MockNotificationSenderBatchSendCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockNotificationSenderBatchSendCall) Do(f func(context.Context, []notification.Notification) (notification.Response, error)) *MockNotificationSenderBatchSendCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockNotificationSenderBatchSendCall) DoAndReturn(f func(context.Context, []notification.Notification) (notification.Response, error)) *MockNotificationSenderBatchSendCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// Send mocks base method.
func (m *MockNotificationSender) Send(ctx context.Context, n notification.Notification) (notification.Response, error) {
	m.ctrl.T.Helper()
...
// Return rewrite *gomock.Call.Return
func (c *MockNotificationSenderSendCall) Return(arg0 notification.Response, arg1 error) *MockNotificationSenderSendCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockNotificationSenderSendCall) Do(f func(context.Context, notification.Notification) (notification.Response, error)) *MockNotificationSenderSendCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockNotificationSenderSendCall) DoAndReturn(f func(context.Context, notification.Notification) (notification.Response, error)) *MockNotificationSenderSendCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
