...
func TestLogicFlow_Deploy_Benchmark(t *testing.T) {
			...
			workflow: Workflow{
				...
				FlowData: LogicFlow{
					Nodes: []map[string]interface{}{
						...
						{"id": "b4845f3c-43f6-4040-81f8-5f96309c0490", "type": "automation", "properties": map[string]interface{}{"name": "自动化-部署", "codebook_id": int64(2001), "runner_id": int64(1001), "is_notify": false}},
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			require.NoError(t, json.Unmarshal([]byte(tc.expectedJSON), &expectedProcess))
